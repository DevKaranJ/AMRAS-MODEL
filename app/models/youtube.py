...
class Thumbnail(Base, TimestampMixin):
    ...
    id: Mapped[int] = mapped_column(primary_key=True)
    job_id: Mapped[int] = mapped_column(ForeignKey("publishing_jobs.id"), index=True)
    ...
    variants: Mapped[List["ThumbnailVariant"]] = relationship(back_populates="thumbnail")
...
class ThumbnailVariant(Base, TimestampMixin):
    ...
    id: Mapped[int] = mapped_column(primary_key=True)
    thumbnail_id: Mapped[int] = mapped_column(ForeignKey("thumbnails.id"), index=True)
...
class Title(Base, TimestampMixin):
    ...
    id: Mapped[int] = mapped_column(primary_key=True)
    profile_id: Mapped[int] = mapped_column(ForeignKey("seo_profiles.id"), index=True)
...
class VideoMetadata(Base, TimestampMixin):
    ...
    id: Mapped[int] = mapped_column(primary_key=True)
    job_id: Mapped[int] = mapped_column(ForeignKey("publishing_jobs.id"), unique=True, index=True)
...
class AnalyticsProfile(Base, TimestampMixin):
    ...
    id: Mapped[int] = mapped_column(primary_key=True)
    job_id: Mapped[int] = mapped_column(ForeignKey("publishing_jobs.id"), unique=True)
